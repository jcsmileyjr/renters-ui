...
export default function Home() {
  /**
   * 1. Seperate sections via Grid by color
   * 2. Setup main title
   ...
   */
  return (
    <main className="grid grid-row-3 grid-column-2">
      <section className="bg-slate-300 col-start-1 col-end-1 row-start-1 row-end-1 row-span-1">Main Title</section>
