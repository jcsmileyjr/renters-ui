...
export default function AddAdvice() {
    return (
        <div className='flex flex-col justify-center items-center mt-8'>
            ...
            <button className='bg-paleYellow text-mediumGray border border-brown border-solid rounded mb-6 sm:mb-0 sm:w-1/3 p-2 flex justify-center items-center gap-2'>
