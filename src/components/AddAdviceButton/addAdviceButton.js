...
export default function AddAdviceButton({newAdvice}) {
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-8 lg:mt-32'>
            {!flipUI &&
                <>
                    <h2 className='font-bold text-2xl text-brown mb-4 underline lg:hidden'>Rental Advice</h2>
